...
class Circuit():
  ...
  def LoadDescription(self, fname):
    ...
    for l in f.readlines():
      ...
      if cmd == "name":
        ...
        x=self.unit*x
        y=self.unit*y
        cur_start_pt=np.array([x,y], dtype=float)
  ...
  def CreateImage(self, zoom_factor=1):
    ...
    print("Create image, red_factor={}".format(self.red_factor))
    ...
    print("### Image : {}x{}, red_factor={}".format(self.pic_width, self.pic_height, self.red_factor))
...
if __name__ == '__main__':
  ...
  circuit.CreateImage(zoom_factor=2)
