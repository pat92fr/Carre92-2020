...
class Simulator(ShowBase):
	...
	def __init__(self, start_position, arch_position, rc, odom):
		...
		self.chassisNP.setPos(self.start_position[0], self.start_position[1], 0.4)
		self.chassisNP.setHpr(self.start_position[2]-90.0, 0.0, 0.0)
		...
		self.gyro_bias = 0.2 #random.uniform(-0.2,0.2) #dps
	...
	def load_map(self):
		...
		self.archNodePath.setPos(self.arch_position[0], self.arch_position[1], 0.0)
		self.archNodePath.setHpr(0.0, 90.0, self.arch_position[2])
